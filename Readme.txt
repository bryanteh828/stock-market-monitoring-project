...
1. pull_price >> pulls stock prices with an input of a stock ticker
	...
	a. price_pull.py >> input of stock ticker & pull stock price via API & output stock prices as .csv (also need to configure directory of output file in the script)
